...
namespace Integrador.ERP.Application.Features.JournalEntry.Commands.Accruals
{
    public class AccrualCommand
    {
        ...
        public List<ItemAccrualVM> items { get; set; } = new List<ItemAccrualVM>();
    }

    public class ItemAccrualVM
    {
